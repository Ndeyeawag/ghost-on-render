import { b0 as Oe, W as Xa, b2 as ll } from "./index-DIak5kz8.mjs";
function fl(r, e) {
...
function g2(r) {
  ...
  if (typeof r == "string") {
    ...
    if (t = typeof r == "function", t === !1 && !h2(r))
      return i;
    n = m2 && t;
  }
  for (a in r)
...
* limitations under the License.
*/
var x2 = typeof Object.getOwnPropertyNames < "u", _2 = x2;
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* limitations under the License.
*/
var j2 = typeof Object.getOwnPropertyDescriptor < "u", B2 = j2;
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
function z2(r, e) {
  var n;
  return r == null ? null : (n = V2(r, e), n === void 0 ? null : n);
}
var Z2 = z2;
/**
* @license Apache-2.0
...
* limitations under the License.
*/
var Q2 = typeof Buffer == "function" ? Buffer : null, K2 = Q2;
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
function eE() {
  ...
  if (typeof Ae != "function")
    return !1;
  try {
    typeof Ae.from == "function" ? e = Ae.from([1, 2, 3, 4]) : e = new Ae([1, 2, 3, 4]), r = rE(e) && e[0] === 1 && e[1] === 2 && e[2] === 3 && e[3] === 4;
  } catch {
    r = !1;
  }
  return r;
...
* limitations under the License.
*/
var nE = tE, iE = nE, eu = {}, nt = {};
nt.byteLength = sE;
nt.toByteArray = lE;
nt.fromByteArray = dE;
var fr = [], Q = [], aE = typeof Uint8Array < "u" ? Uint8Array : Array, bt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var Pr = 0, oE = bt.length; Pr < oE; ++Pr)
...
function lE(r) {
  var e, n = tu(r), t = n[0], i = n[1], a = new aE(uE(r, t, i)), l = 0, u = i > 0 ? t - 4 : t, d;
  for (d = 0; d < u; d += 4)
...
function cE(r, e, n) {
  for (var t, i = [], a = e; a < n; a += 3)
    t = (r[a] << 16 & 16711680) + (r[a + 1] << 8 & 65280) + (r[a + 2] & 255), i.push(fE(t));
  return i.join("");
}
function dE(r) {
  for (var e, n = r.length, t = n % 3, i = [], a = 16383, l = 0, u = n - t; l < u; l += a)
    i.push(cE(r, l, l + a > u ? u : l + a));
...
* limitations under the License.
*/
var UE = z, RE = typeof Int8Array == "function";
function jE(r) {
  return RE && r instanceof Int8Array || // eslint-disable-line stdlib/require-globals
  UE(r) === "[object Int8Array]";
}
var BE = jE;
/**
* @license Apache-2.0
...
* limitations under the License.
*/
var WE = typeof Int8Array == "function" ? Int8Array : null, YE = WE;
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
//# sourceMappingURL=index-BeD9DTp3.mjs.map
